    ...
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            res = _context2.sent;
            return _context2.abrupt('return', Boolean(res.trim()) ? true : false);
...
var mapAsync = exports.mapAsync = function () {
  var _ref6 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5(arr, callback) {
    var results, i;
...
function requireJson(path) {
  return JSON.parse(_fsExtra2.default.readFileSync(path, 'utf8'));
}
...
// or
// - default dir folder
function extractHandlers(_ref5) {
  ...
  return names.map(function (name) {
    ...
    var handlerPath = _path2.default.extname(name) !== '' && fileExists(cwdFilePath) ? cwdFilePath : fileExists(defaultFilePath) ? defaultFilePath : null;
...
function copy(src, dest) {
  var _ref7 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
      _ref7$overwrite = _ref7.overwrite,
      overwrite = _ref7$overwrite === undefined ? false : _ref7$overwrite;
 ...
 */
function mergeToJsonFile(_ref8) {
  var jsonToMerge = _ref8.json,
      dest = _ref8.dest;
