...
function tasks(_ref4) {
  ...
  return commandRunner({ options: flags, args: args, defaultDir: _config2.default.defaultTaskDir, name: 'TASKS' });
}
...
function buildorders(_ref5) {
  ...
  return commandRunner({ options: flags, args: args, defaultDir: _config2.default.defaultBuildOrdersDir, name: 'BUILD ORDER' });
}